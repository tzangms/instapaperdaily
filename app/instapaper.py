...
class Instapaper(object):
    ...
    def __init__(self, oauth_key, oauth_secret, oauth_token=None, oauth_token_secret=None):
    ...
    def login(self, username, password):
        ...
        token = dict(parse.parse_qsl(response['data'].decode()))
        try:
    ...
    def verify_credentials(self):
        resp = self.request('account/verify_credentials')
        return resp['data'][0]
    ...
    def request(self, path, params=None, returns_json=True,
        ...
        params = parse.urlencode(params) if params else None
...
class Bookmark(InstapaperObject):
    ...
    def archive(self):
        params = {'bookmark_id': self.bookmark_id}
        resp = self.client.request('bookmarks/archive', params)
        return resp['data']
